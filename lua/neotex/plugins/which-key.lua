...
return {
  ...
  opts = {
    ...
    defaults = {
      ...
      C = { "<cmd>vsplit | Telescope buffers<CR>", "split buffer picker" },
      ...
      a = {
        ...
        l = { "<cmd>cd " .. vim.fn.stdpath("config") .. "/snippets/lua | NvimTreeOpen<CR>", "luasnip snippets" },
        ...
        s = { "<cmd>cd " .. vim.fn.stdpath("config") .. "/snippets/snipmate | NvimTreeOpen<CR>", "snipmate snippets" },
    ...
    -- { '<leader>g', group = ' Git' },
      ...
      r = {
        name = "RUN",
        d = { "<cmd>lua Snacks.dashboard()<CR>", "Snacks Dashboard" },
